...
<head>
  ...
  <link rel="stylesheet" href="${url}global/vendor/jvectormap/jquery-jvectormap.min599c.css?v4.0.2">
  <link rel="stylesheet" href="${url}global/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.min599c.css?v4.0.2">

  <!-- Page -->
  <link rel="stylesheet" href="${url}assets/examples/css/dashboard/v1.min599c.css?v4.0.2">
</head>
<body class="animsition dashboard">
  ...
  <!-- End Page -->
		...
		<jsp:include page="header/plugins/jsPlugins.jsp"/>
		<!-- Plugins For This Page -->
		<script src="${url}global/vendor/skycons/skycons599c.js?v4.0.2"></script>
		<script src="${url}global/vendor/chartist/chartist.min599c.js?v4.0.2"></script>
		<script
			src="${url}global/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.min599c.js?v4.0.2"></script>
		<script
			src="${url}global/vendor/aspieprogress/jquery-asPieProgress.min599c.js?v4.0.2"></script>
		<script
			src="${url}global/vendor/jvectormap/jquery-jvectormap.min599c.js?v4.0.2"></script>
		<script
			src="${url}global/vendor/jvectormap/maps/jquery-jvectormap-au-mill-en599c.js?v4.0.2"></script>
		<script
			src="${url}global/vendor/matchheight/jquery.matchHeight-min599c.js?v4.0.2"></script>
		...
		<script src="${url}global/js/Plugin/jvectormap.min599c.js?v4.0.2"></script>
		<script src="${url}assets/examples/js/dashboard/v1.min599c.js?v4.0.2"></script></body>
</html>