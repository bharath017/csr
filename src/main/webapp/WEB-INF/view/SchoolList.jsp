...
<body class="animsition ">
  ...
  <div class="page">
    <div class="page-header">
      <h1 class="page-title">School List</h1>
		                ...
		                <div class="row">
		                	<div class="col-lg-12">
		                		<form id="search-form">
				                	<div class="row">
					                	<div class="col-lg-4">
					                		 <input type="text" class="form-control" id="school_name" placeholder="Search...">
					                	</div>
					                	<div class="col-lg-4">
  ...
  <script type="text/javascript" src="${url}pageJs/school/SchoolList.js"></script>
</body>
</html>